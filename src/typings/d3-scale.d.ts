...
interface ScaleLinear<Range, Output> extends ScaleNumeric<Output> {
    (value: Numeric): Output;
    /**
...
export interface ScalePower<Range, Output> extends ScaleNumeric<Output> {
    (value: Numeric): Output;
    /**
     * Important: While value should come out of range R, this is method is only applicable to
     * values that can be coerced to numeric. Otherwise, returns NaN
...
export interface ScaleLogarithmic<Range, Output> extends ScaleNumeric<Output> {
    (value: Numeric): Output;
    /**
     * Important: While value should come out of range R, this is method is only applicable to
     * values that can be coerced to numeric. Otherwise, returns NaN
...
interface ScaleIdentity extends ScaleNumeric<number> {
